...
import/websites/gr.maharashtra.gov.in/Tribal:
	cd import/websites/gr.maharashtra.gov.in/ && ln -s $(GR_DIR)/Tribal .
...
import: check_env import/websites/gr.maharashtra.gov.in/Tribal .secrets/google.token 
	poetry run python import/src/build_documents.py import/websites/gr.maharashtra.gov.in/Tribal import/documents
