...
1. [mahtrib-*.pdf.en.txt](flow/writeTxt_/output/): Orders in Marathi.

2. [mahtrib-*.pdf.mr.txt](flow/writeTxt_/output/): Orders in English.
...
- **Last Order:** [202309081704481424.pdf](https://gr.maharashtra.gov.in/Site/Upload/Government%20Resolutions/English/202309081704481424.pdf) (08 September 2023)
- **Last Crawl Date:** 11-Sep-2023
- **Total Orders:** 1642
- **Translated Orders:** 1622
...
```
git clone https://github.com/orgpedia/mahtrib.git
```
